...
os.system('fift -s {} -1 > {}\n'.format(NEW_DNS_SCRIPT, DNS_INFO))
...
os.system(send_query.format(QUERY_PATH, 'wallet-query.boc'))
time.sleep(5)

# init DNS
if (len(sys.argv) < 3):
    os.system(send_query.format(QUERY_PATH, 'new-dns-query.boc'))
